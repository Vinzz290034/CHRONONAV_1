...
require_once '../../includes/functions.php'; // Assuming requireRole() or similar might be here

// Ensure user is logged in and has the 'faculty' role (adjust if settings are universal)
requireRole(['faculty']);
...
$page_title = "Settings";
$current_page = "settings"; // For active sidebar link, ensure this matches data-page in sidenav_faculty.php
...
<link rel="stylesheet" href="../../assets/css/faculty_css/faculty_settings.css">
...
<script>
    // Toggle settings can be saved via AJAX here
    $('#voiceGuidance, #contrastMode').change(function () {
        let setting = $(this).attr('id');
        let value = $(this).is(':checked') ? 1 : 0;
        // Optional: Send via AJAX to save user preferences
        console.log(setting + ' changed to ' + value);
    });

    // JavaScript to enable/disable the deactivate button based on the checkbox
