    ...
    <link rel="icon" type="image/x-icon" href="https://res.cloudinary.com/deua2yipj/image/upload/v1758917007/ChronoNav_logo_muon27.png">
      ...
      <style>
          ...
          @media (max-width: 480px) {
              ...
              .auth-modal-header, .auth-modal-footer {
        ...
        <div class="auth-register-card">
            ...
            <form method="POST" id="registerForm">
                <div class="auth-form-group">
                    ...
                    <input type="text" class="auth-form-control" id="name" name="name" placeholder="Enter your full name" value="<?= htmlspecialchars($_POST['name'] ?? '') ?>" required>
                </div>
                ...
                <div class="auth-form-group">
                    ...
                    <div class="auth-password-input">
                        <input type="password" class="auth-form-control" id="password" name="password" placeholder="Create a password (min. 6 characters)" required>
                ...
                <div class="auth-form-group">
                    ...
                    <select class="auth-form-select" id="role" name="role" required>
                        ...
                        <option value="faculty" <?= (($_POST['role'] ?? '') == 'faculty') ? 'selected' : '' ?>>Teacher</option>
                ...
                <div class="auth-form-group">
                    ...
                    <input type="text" class="auth-form-control" id="course" name="course" placeholder="Enter your course" value="<?= htmlspecialchars($_POST['course'] ?? '') ?>" required>
                </div>
                
                <div class="auth-form-group">
                    <label for="department" class="auth-form-label fw-bold text-black-50">Department</label>
                    <input type="text" class="auth-form-control" id="department" name="department" placeholder="Enter your department" value="<?= htmlspecialchars($_POST['department'] ?? '') ?>" required>
                </div>
